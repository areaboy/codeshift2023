...
Admin Signup System....<br><br>
 <div class="form-group">
              ...
              <input type="text" class="col-sm-12 form-control" id="fullname_s" name="fullname_s"  value="Esedo Fredrick">
            </div>
 ...
 <div class="form-group">
              <label>Email: </label>
              <input type="text" class="col-sm-12 form-control" id="username_s" name="username_s"  value="codeshift2023@gmail.com">
            </div>
 
 <div class="form-group">
              <label>Password: </label>
              <input type="password" class="col-sm-12 form-control" id="password_s" name="password_s"  value="codeshift2023">
            </div>

 <div class="form-group">
              <label>Confirm - Password: </label>
              <input type="password" class="col-sm-12 form-control" id="password_sx" name="password_sx"  value="codeshift2023">
            </div>
...
<div class="modal fade" id="myModal_login">
 ...
 <div class="form-group  hide_form2">
              <label>Email: </label>
              <input type="text" class="col-sm-12 form-control" id="username" name="username"  value="codeshift2023@gmail.com">
            </div>
 
 <div class="form-group  hide_form2">
              <label>Password: </label>
              <input type="password" class="col-sm-12 form-control" id="password" name="password"  placeholder='Enter Password' value="codeshift2023">
            </div>
</div>
